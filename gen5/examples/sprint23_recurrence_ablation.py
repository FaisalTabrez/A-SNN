"""Sprint 23 CLI: causal recurrence ablation on temporal-state MNIST."""
...
from ammc_gen5 import EventMNISTConfig, run_recurrence_ablation  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Phase 23 causal recurrence ablation")
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/recurrence_ablation")
...
def main() -> None:
    ...
    result = run_recurrence_ablation(config, device=args.device)
