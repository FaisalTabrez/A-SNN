"""Sprint 24 CLI: final-state recurrence on row-sequential MNIST."""
...
from ammc_gen5 import EventMNISTConfig, run_sequential_mnist  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Phase 24 sequential MNIST benchmark")
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/sequential_mnist")
...
def main() -> None:
    ...
    result = run_sequential_mnist(config, device=args.device)
