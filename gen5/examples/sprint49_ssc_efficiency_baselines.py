"""Sprint 49 CLI: matched SSC TCN and residual-LIF efficiency audit."""
...
from ammc_gen5 import SHDConfig, run_ssc_efficiency_baselines  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 49 SSC efficiency baselines")
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/ssc_efficiency_baselines")
...
def main() -> None:
    ...
    result = run_ssc_efficiency_baselines(
        config,
