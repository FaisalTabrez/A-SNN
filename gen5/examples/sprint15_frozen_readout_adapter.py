"""Sprint 15: frozen readout/transducer adapter.

This runner keeps the AMMC recurrent sparse substrate frozen and trains only a
small deployable adapter over frozen trace features. It is the practical bridge
between the diagnostic representation probe and full recurrent/plastic training.
...
For a stricter test of the current motor pathway, rerun with:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run AMMC Gen-5 frozen readout/transducer adapter")
    ...
    parser.add_argument("--adapter-kind", choices=("linear", "mlp"), default="linear")
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/frozen_readout_adapter")
