"""Sprint 20 CLI: preserve per-timestep frozen AMMC state on MNIST."""
...
from ammc_gen5 import EventMNISTConfig, run_temporal_mnist  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Phase 20 temporal-state MNIST benchmark")
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/event_mnist_temporal")
...
def main() -> None:
    ...
    result = run_temporal_mnist(config, device=args.device)
