"""Sprint 34 CLI: validate SHD hidden-capacity scaling without delays."""
...
from ammc_gen5 import SHDConfig, run_shd_capacity_scaling  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 34 SHD capacity scaling")
    ...
    parser.add_argument("--delay-anchor", type=int, default=256)
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/shd_capacity")
...
def main() -> None:
    ...
    config = SHDConfig(
        ...
        hidden_neurons=min(args.hidden_neuron_counts),
    ...
    result = run_shd_capacity_scaling(
        config,
        hidden_counts=args.hidden_neuron_counts,
        delay_anchor=args.delay_anchor,
        device=args.device,
