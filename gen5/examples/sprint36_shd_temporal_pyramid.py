"""Sprint 36 CLI: parameter-matched temporal-pyramid readouts on SHD."""
...
from ammc_gen5 import SHDConfig, run_shd_temporal_pyramid  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Phase 36 parameter-matched SHD temporal pyramid"
    )
    ...
    parser.add_argument(
        "--output-dir", default="gen5_outputs/shd_temporal_pyramid"
    )
...
def main() -> None:
    ...
    result = run_shd_temporal_pyramid(
        config,
        device=args.device,
        surrogate_slope=args.surrogate_slope,
        projection_dim=args.projection_dim,
        temporal_levels=args.temporal_levels,
        baseline_readout_hidden_units=args.readout_hidden_units,
