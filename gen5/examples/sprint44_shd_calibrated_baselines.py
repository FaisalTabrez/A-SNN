"""Sprint 44 CLI: validation-calibrated temporal baselines on SHD."""
...
from ammc_gen5 import SHDConfig, run_shd_calibrated_baselines  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 44 calibrated SHD temporal baselines")
    ...
    parser.add_argument("--raw-projection-dim", type=int, default=32)
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/shd_calibrated_baselines")
...
def main() -> None:
    ...
    result = run_shd_calibrated_baselines(
