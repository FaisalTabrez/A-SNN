"""Sprint 47 CLI: test causal contribution of residual temporal state."""
...
from ammc_gen5 import SHDConfig, run_shd_residual_state_contribution  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 47 SHD residual-state contribution ablation")
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/shd_residual_state_contribution")
...
def main() -> None:
    ...
    result = run_shd_residual_state_contribution(
        config,
