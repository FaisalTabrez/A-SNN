"""Sprint 19 CLI: decompose information loss in event-coded MNIST traces."""
...
from ammc_gen5 import EventMNISTConfig, run_event_mnist_decomposition  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Phase 19 MNIST representation decomposition")
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/event_mnist_decomposition")
...
def main() -> None:
    ...
    result = run_event_mnist_decomposition(config, device=args.device)
