"""Sprint 39 CLI: isolate spiking and LTW learning on SHD."""
...
from ammc_gen5 import SHDConfig, run_shd_sparse_mechanisms  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 39 SHD sparse mechanism ablation")
    ...
    parser.add_argument("--hidden-neurons", type=int, default=512)
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/shd_sparse_mechanisms")
...
def main() -> None:
    ...
    result = run_shd_sparse_mechanisms(
        config,
        hidden_neurons=args.hidden_neurons,
        device=args.device,
