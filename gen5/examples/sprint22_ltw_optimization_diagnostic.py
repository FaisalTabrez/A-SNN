"""Sprint 22 CLI: diagnose stable fixed-topology LTW optimization."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Phase 22 LTW optimization diagnostic")
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/ltw_optimization_diagnostic")
...
def main() -> None:
    args = parse_args()
    if args.list_arms:
        print("\n".join(available_ltw_diagnostic_arms()))
        return
    ...
    result = run_ltw_optimization_diagnostic(
        config,
        device=args.device,
