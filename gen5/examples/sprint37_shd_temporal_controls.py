"""Sprint 37 CLI: decompose SHD temporal-readout and recurrence gains."""
...
from ammc_gen5 import SHDConfig, run_shd_temporal_controls  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 37 SHD temporal controls")
    ...
    parser.add_argument(
        "--output-dir", default="gen5_outputs/shd_temporal_controls"
    )
...
def main() -> None:
    ...
    result = run_shd_temporal_controls(
        config,
        hidden_neurons=args.hidden_neurons,
        device=args.device,
