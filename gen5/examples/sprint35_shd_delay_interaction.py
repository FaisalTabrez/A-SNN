"""Sprint 35 CLI: test capacity-by-delay interaction on SHD."""
...
from ammc_gen5 import SHDConfig, run_shd_delay_interaction  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Phase 35 SHD capacity-by-delay interaction"
    )
    parser.add_argument("--seeds", nargs="+", type=int, default=[42, 43, 44])
    parser.add_argument(
        "--hidden-neuron-counts", nargs="+", type=int, default=[256, 512]
    )
    ...
    parser.add_argument(
        "--output-dir", default="gen5_outputs/shd_delay_interaction"
    )
...
def main() -> None:
    ...
    result = run_shd_delay_interaction(
        config,
