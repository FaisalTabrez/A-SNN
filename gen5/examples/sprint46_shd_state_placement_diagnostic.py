"""Sprint 46 CLI: diagnose where temporal state damages SHD features."""
...
from ammc_gen5 import SHDConfig, run_shd_state_placement_diagnostic  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 46 SHD state-placement diagnostic")
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/shd_state_placement_diagnostic")
...
def main() -> None:
    ...
    result = run_shd_state_placement_diagnostic(
        config,
