"""Sprint 21 CLI: train fixed-topology AMMC LTWs on temporal MNIST."""
...
from ammc_gen5 import EventMNISTConfig, run_trainable_temporal_mnist  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the Phase 21 fixed-topology LTW-training MNIST benchmark"
    )
    ...
    parser.add_argument("--reservoir-learning-rate", type=float, default=0.001)
    ...
    parser.add_argument("--output-dir", default="gen5_outputs/trainable_temporal_mnist")
...
def main() -> None:
    ...
    result = run_trainable_temporal_mnist(
        config,
        device=args.device,
